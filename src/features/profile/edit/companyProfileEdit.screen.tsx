...
import { INDUSTRY_EXPERIENCE_OPTIONS, RESIDENCY_STATUS_OPTIONS, DEGREE_OPTIONS } from "./profileEdit.constants";
...
export default function CompanyProfileEditScreen() { //renamed to be called by the company-profile-edit.tsx file
  const {
    MAX_HIGHER_ED,
    scrollRef,
    draft,
